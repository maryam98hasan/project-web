...
<center>
 <h3 style="color:#DC143C">عرض  أسماء القاعات  </h3>
 </center>
<body>
<?php
...
$qs=mysqli_query($link,'select  id,name,location,price,size,time from halls');
echo"<br> ";
echo"<center>"	;
echo '<table border="2"  width="1000" height="400"style="color:white;font-size:100;background:#DC143C">';
   echo '<tr>';
	   echo '<td>معرف القاعة  </td>';
       echo '<td>أسم القاعة </td>';
       echo '<td>موقع القاعة </td>';
       echo '<td>سعر القاعة </td>';
	    echo '<td>سعة القاعة  </td>';
