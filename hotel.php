...
<center>
<h3><p style="color:#DC143C">حجز فندق لشهر العسل</p></h3>
</center>
 <form  action="bookinghotel.php" method='post'>
<div class="body">
		    <center>
			 <br>
	        ...
	        <div class="borderflight">
	            ...
	            <form>
                   ...
                   <input type="text" name="name" size="40" required> : أسم الفندق 
				  <br>
				  <br>

                   
				   <input type="date" name="data"  max="2100-01-01"  min= "2018-5-4"required> : تاريخ الحجز
			      ...
			      <br>
	               ...
	               <input type="text" name="Gmail" size="40" required>:  Gmail
...
<blockquote>
			<blockquote>
			<img src="m/big.18690.jpg" width="540" height="330">
		    <img src="m/HI332793126.jpg" width="540" height="330">
			<br>
	        <img src="m/DovICqiXUAAVVal.jpg" width="540" height="330">
		    <img src="m/69527155.jpg" width="540" height="330">
			<br>
			<br>
