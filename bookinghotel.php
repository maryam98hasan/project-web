...
$link = mysqli_connect("localhost", "root", "", "wedding");
	...
	$data=$_POST['data'];
		...
		$qi=mysqli_query($link,"insert into hotel values('$name','$data')");;
		 echo"<h1>";
	echo"
  <script>
  alert('you are   BOOKING room in hotel ');
  </script>
...
<form class="modal-content animate" action="logmy.php " method="post">
    <div class="imgcontainer">
         <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
         <img src="m/12.png" alt="Avatar" class="avatar">
    </div>

    <div class="container">
         <label for="name"><b>Username</b></label>
         <input type="text" placeholder="Enter Username" name="c_name" >

         <label for="passowrd"><b>Password</b></label>
         <input type="password" placeholder="Enter Password" name="c_passowrd">
</form>
...
<div class="transbox">
  ...
  <tr>
     <td> 
           <img src="w/4.jpg"  width="500" height="300"></td>
      <td> 
           <img src="w/50.jpg"  width="500" height="300"></td>
      <td> 
           <img src="w/e.jpg"  width="335" height="300"></td>
   </tr>
   </table>
</div> </br>
<p>
  <h1>
    <center>
      <font face= "courier" ; size='5' style="color:black">حجز قاعات الزفاف </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5'style="color:black">الحجز الألكتروني لقاعات الأفراح في العراق </font>
      </center>
	  <center>
      <font face= "courier" ; size='5'style="color:black"> موقع زفافك المجاني سريع وبسيط الاستعمال </font>
      </center>
  </h1>
</p>
</br></br></br></br></br></br></br></br></br></br>
<center><h2>بسرعة إعداد موقع الزفاف الخاص بك</h2></br>
<center><h2> اختر التصميم المفضل لديك استنادًا إلى لوحة الألوان أو تصميم الدعوة  </h2></br>

<table cellpadding="10">
<tr>
  <td >
      <img src="w/thumb_big_anemones.jpg" width="380" height="250" >
  </td>
  <td>
      <img src="w/thumb_big_block-print.jpg" width="380" height="250" >
   </td>
  <td>
      <img src="w/gen_hero_en-US.png" width="380" height="250" >
  </td>
</tr>
<tr>
  
   <td>
      <img src="w/thumb_big_confetti.jpg" width="380" height="250" >
  </td>
  <td >
      <img src="w/thumb_big_tassels.jpg" width="380" height="250" >
  </td>
  <td>
      <img src="w/thumb_big_modern_1.jpg" width="380" height="250" >
   </td>
...
<tr>
   ...
   <td>
      <img src="w/thumb_big_water-colorflorals.jpg" width="380" height="250" >
  </td>
  <td >
      <img src="w/thumb_big_modern-photo.jpg" width="380" height="250" >
  </td>
  <td>
      <img src="w/thumb_big_carrera.jpg" width="380" height="250" >
   </td>
 
</tr>
</table></br></br>
<input  id ="subn" type="submit"  name='submit' value=" مشاهدة المزيد "size=" 10"  /></center>
