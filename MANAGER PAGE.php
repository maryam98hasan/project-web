...
<br>
<center><h2 style="color:#DC143C;">مرحبا بك في صفحة المدير</h2></center>
<center>
<table width="800" height="400" bgcolor ="#DC143C"  border ="10" border color="#DC143C"  cellpadding="10" cellspacing="10" >
<tr>
 <form action="add new manger.php" method="post">
<td><center><p style=font-size:25p><h1><mark>أضافة مدير جديد </h1><input type="submit" style=font-size:25pt value=" أنقر هنا"></center></td>
</form>
 <form action="  add new hall.php" method="post">
<td><center><p style=font-size:31pt><h1><mark>أضافة قاعة </h1></mark><input type="submit" style=font-size:25pt  value="  أنقر هنا" ></center></td>
</tr>
</form>
<tr>
</form>
 <form action="DELET HALL.PHP" method="post">

<td><center><p style=font-size:20pt><h1><mark> حذف قاعة  </h1><input type="submit"style=font-size:25pt  value="  أنقر هنا  "></center></td>

</form>

 <form action="manger show .php" method="post">
<td><center><p style=font-size:25p><h1><mark>عرض القاعات </h1><input type="submit" style=font-size:25pt value=" أنقر هنا "></center></td>
</form>
</tr>

 <tr>
 <form action="view hall select .php" method="post">
<td><center><p style=font-size:25p><h1><mark>عرض القاعات المحجوزة </h1><input type="submit" style=font-size:25pt value="أنقر هنا"></center></td>
</form>
 <form action="mod.php" method="post">
<td><center><p style=font-size:25p><h1><mark>تحديث على القاعات </h1><input type="submit" style=font-size:25pt value=" أنقر هنا "></center></td>
</form>
</tr>
</center>
</table>
