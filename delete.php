...
<center>
<h3><p style="color:#DC143C">ألغاء الحجز  </p></h3>
</center>
...
<div class="body">
	        ...
	        <div class="borderflight">
	            ...
	            <form>
                   ...
                   <input  class='inputm' type="text" name="name" size="40" required> : أسم القاعة 
				  <br>
				  <br>

                   
				   <input class='inputm' type="date" name="data"  max="2100-01-01"  min= "2018-5-4"required>  : تاريخ الحجز 
                  
				    <br>
				    <br>
					
	               <input class='inputm' type="text" name="Gmail" size="40" >  : Gmail
                  
				    <br>
				    <br>
					
				   <input class='inputm' type="datetime" name="time"  > : وقت الحجز 
...
<blockquote>
			<blockquote>
			<img src="m/90.jpeg" width="540" height="330">
		    <img src="m/88.jpg" width="540" height="330">
			<br>
	        <img src="m/91.jpg" width="540" height="330">
		    <img src="m/87.jpg" width="540" height="330">
			<br>
			<br>
