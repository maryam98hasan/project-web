...
<li><a href=" Reservations.html"><big>العروض الأضافية</big></a></li>
<li><a href="date of select.php"><big>تاريخ الحجز</big></a></li>
<li><a href="hall.php"><big>القاعات</big></a></li>
</ul></header>
</br> </br></br>
<center>
      <font face= "courier" ; size='5' style="color:black"><p>مرحبا بكم في العروض الأضافية </p></font>
	   <font face= "courier" ; size='5' style="color:black"><p>يوجد لدينا العديد من العروض الأضافية التي سوف تساعدك في أختيار التصاميم الخاصة بك </p></font>
	  <font face= "courier" ; size='5' style="color:black"><p>صمم الأن الزفاف الذي كنت تحلم به شاهد جميع العروض وقم بأختيار العرض الذي يناسبك</p></font>
	 	  <font face= "courier" ; size='5' style="color:black"><p>تواصل معنا لتصميم العرض الذي يناسبك مع الأضافات التي ترغب بها</p></font>
	 </center> 

<ol id="scrolling-list">
  <li><a  tabindex=1 href='dresses wedding.php'><img src="m/50.jpg" height='200px'height=150 >فساتين الزفاف</a>
  <li><a  tabindex=2 href='find dress.php'><img src="m/1-romantic-lace-wedding-gown-1300x1765.jpg" height=150>كيفية التسوق لفستان الزفاف </a>
  <li><a tabindex=3 href='decor.php'><img src="m/d1.jpg" height=150>ديكورات الزفاف</a>
  <li><a  tabindex=5 href='hotel.php'><img src="m/Hotel-Josef-Prag-Josef-Balcony-Rooms-00039-1-968x646.jpg" height=150>حجز فندق </a>
   
</ol>
<!-- tabindex used to force priority on elements; generally speaking, tabindex should be avoided in production -->
<table align="right" style="background-color:#333333;">
<tbody> <tr valign="top">
<td><table   dir="rtl" width="830" height="800" style="background-color:#f5f5f5;"></td>
</tbody></table>
<td>
...
<tr>
	...
	<font color="ffffff"size=4><li>الوجبات</li></font>
	 ...
	 <font color="ffffff" size=4><li>حجز القاعات</li></font>
	  <font color="ffffff"size=4><li>التخطيط لزفافكم</li></font>
...
<tr>
<td> <input  id ="subm" type="email"  placeholder="عنوان البريد الألكتروني">
&nbsp&nbsp&nbsp&nbsp
<input  id ="subz" type="submit"  name='submit' value=" أشتراك "size=" 10"  />
</br>
</br>
<font color="ffffff" size=4>لمزيد من التفاصيل عن كيفية استخدامنا لمعلوماتكم، </font>
</br>
