...
<center>
 <h3 style="color:#DC143C">تحديث القاعات  </h3>
 <form action="modfiy2.php "  method="post">
<div class="body">
		   ...
		   <div class="borderflight">
	               ...
	               <p style='color:black;font-size:25'>
				    معرف القاعة:
                   <input class='inputm'  "type="text" name="id" size="40" required></abbr>
				     <br><br>
				  ...
				  <input class='inputm' type="TEXT" name="name" />
				      ...
				      <br><br>
                     موقع القاعة :
                   <input class='inputm' type="text" name="location" size="40" required></abbr>
				     <br><br>
				  ...
				  <input class='inputm'type="TEXT" name="price" />
				      <br><br>
				     سعة القاعة :
                   <input class=' inputm'type="text" name="size" size="40" required></abbr>
				    <br><br>
                  وقت الحجز :
				  <input class='inputm'type="time" name="time" />
                  <br><br>
	              <input type="submit"  value="update">تحديث
				  </form>
...
<table align="right" style="background-color:#333333;">
    <tbody> 
	      <tr valign="top">
          <td>
              <table dir="rtl" width="930" height="400" style="background-color:#f5f5f5;">
         </td>
    </tbody>
</table>
    <td>
	   <table  dir="rtl" width="1400" padding="20px"margin="20px" >
       <tbody>
    <tr>
