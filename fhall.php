<html>
<head>
<title>القاعة الاولى</title>
<link href="styelH.css" rel="stylesheet" type="text/css">
</head>
<body>
<header>
<ul id='right-nav'> 
...
<center> 
<img src="project/m/قاعه1.png"  width="700" height="350" > 
</center>  
  <h2  align ="right" style="font-family:arial;"> 
    <center>
      <font face= "courier" ; size='5' style="color:black">قاعة الروان  </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black">بأمكانكم الان من موقعكم حجز هذه القاعه </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black">اقصى وقت لحجز القاعة هو ثلاث ساعات ولتحديد</font>
	  </center>
	   <center>
      <font face= "courier" ; size='5' style="color:black">الوقت الذي يناسبكم يرجى الانتقال الى صفحة </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black">الحجز  موقع القاعة هو حي الأمين تتسع </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black"> القاعة الى مايقارب 300شخصا سعر الحجز 500 </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black">  الف من دون أجور الأضافات على حجزكم لمعرفة العروض   </font>
	  </center>
	  <center>
      <font face= "courier" ; size='5' style="color:black">  الأضافية يرجى الأنتقال الى صفحة العروض الأضافية   </font>
	  </center>
	  </br></br></br>
<center>
<a href="add.php" >
<input  id ="subn" type="submit"  name='submit' value=" العروض الأضافية  "size=" 5"  />
</center>
                        			

 <table align="right" style="background-color:#333333;">
<tbody> <tr valign="top">
<td><table   dir="rtl" width="830" height="800" style="background-color:black;"></td>
</tbody></table>
<td>
